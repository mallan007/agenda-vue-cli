...
<template>
    ...
    dark:text-white focus:ring-4 focus:outline-none focus:ring-fuchsia-200 dark:focus:ring-fuchsia-800">
        <svg class="w-6 h-6 text-white-950 dark:text-white-950" shadow-md sm:rounded-lg px-2.5 py-2.5 aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      <thead class="text-xs text-fuscia-200 dark:text-fuchsia-200 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
        <tr>
          <th>
            Lista de Contatos
          </th>
        ...
        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
          <td scope="row" class="px-6 py-4 font-medium text-fuchsia-600 dark:text-fuchsia-500 hover:underline ">
            <div class="flex items-center gap-2">
              <span class="inline-flex items-center px-2.5 py-2.5 text-sm text-gray-900 border border-fuchsia-500 rounded-full">
